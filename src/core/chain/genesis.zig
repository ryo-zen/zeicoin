...
pub const GenesisBlocks = struct {
    ...
    pub const TESTNET = struct {
        ...
        pub const HASH: [32]u8 = [_]u8{
            0xd2, 0x6f, 0x16, 0xbc, 0xf6, 0xb5, 0x7e, 0xf3,
            0x14, 0x15, 0x2c, 0xe6, 0x33, 0x84, 0xa5, 0x82,
            0xed, 0xeb, 0x1b, 0x66, 0xd8, 0x42, 0x27, 0x09,
            0x47, 0x06, 0x7b, 0x6c, 0x6e, 0x74, 0xfd, 0xdc
        };
