...
/// Sync Manager - ZSP-001 compliant synchronization coordinator
/// Manages batch sync protocol with sequential sync utilities
pub const SyncManager = struct {
    ...
    pub fn startSync(self: *Self, peer: *net.Peer, target_height: u32) !void {
        ...
        // ZSP-001: Always use batch sync protocol
        print("🚀 [SYNC] Using ZSP-001 batch sync protocol\n", .{});
        try self.startBatchSync(peer, target_height);
    }
