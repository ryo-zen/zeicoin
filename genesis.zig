...
pub const GenesisBlocks = struct {
    ...
    pub const TESTNET = struct {
        pub const HASH: [32]u8 = [_]u8{
            0x8f, 0x34, 0x9a, 0x77, 0xbc, 0x21, 0x4e, 0x65,
            0x3f, 0x88, 0x92, 0xd5, 0x41, 0x7f, 0x1c, 0x09,
            0xe6, 0x73, 0xb8, 0x45, 0x2a, 0x91, 0xf7, 0x38,
            0xd2, 0x6c, 0xa4, 0x15, 0x89, 0x7e, 0x53, 0xb7
        };
        ...
        pub const NONCE: u64 = 0x7E57DE7; // "TESTNET" in hex-speak
    ...
    pub const MAINNET = struct {
        ...
        pub const NONCE: u64 = 0x3A1F1E7; // "MAINNET" in hex-speak
